...
| Full connected suite | Passed | `ANDROID_SERIAL=emulator-5554 ./gradlew --no-daemon :app:connectedDebugAndroidTest` | Medium Phone AVD, Android 16/API 36 | 2026-08-26 | 105 passed; 0 failed, 0 errors, 0 skipped |
| Room migration and DAO behavior | Passed | Full connected suite | Medium Phone AVD, API 36 | 2026-08-26 | DAO, migration, Replace All, rollback, Quick Capture refresh, natural-language save, setup-failure-safe row/sequence/live-alarm restoration, and deterministic completion/save/reminder interleavings passed within 105 tests |
...
| Natural-language connected product journey | Passed | Focused and full connected suites | Medium Phone AVD, Android 16/API 36 | 2026-08-26 | 3 product journeys plus 1 forced setup-failure cleanup regression: bilingual save/list/Room/live-alarm proof, exact recreation retention, and load-bearing exceptional cleanup |
