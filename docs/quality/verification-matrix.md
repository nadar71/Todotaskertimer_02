...
| Full connected suite | Passed | `ANDROID_SERIAL=emulator-5554 ./gradlew --no-daemon :app:connectedDebugAndroidTest` | Medium Phone AVD, Android 16/API 36 | 2026-08-26 | 104 passed; 0 failed, 0 errors, 0 skipped |
| Room migration and DAO behavior | Passed | Full connected suite | Medium Phone AVD, API 36 | 2026-08-26 | DAO, migration, Replace All, rollback, Quick Capture refresh, natural-language save, exact fixture sequence restoration, and deterministic completion/save/reminder interleavings passed within 104 tests |
...
| Natural-language connected product journey | Passed | Focused and full connected suites | Medium Phone AVD, Android 16/API 36 | 2026-08-26 | 3/3: independent Italian/English parse-correct-describe-save, list navigation, Room persistence, and live AlarmManager registry proof plus exact relative-date UI retention across recreation without reparse |
